...
# UltraDeepThink Mac Server - Auto Setup Script
# This script automatically sets up and runs the Mac HTTP server for iPad communication

echo "🚀 UltraDeepThink Mac Server - Auto Setup"
echo "=========================================="
echo ""
...
if [ ! -f "http-server.swift" ]; then
    ...
    echo "💡 Make sure you're running this from the MacCompanion directory"
    exit 1
fi
...
echo "📱 iPad should connect to: http://$LOCAL_IP:8080"
echo "🎯 Server will auto-type when iPad sends messages"
echo ""
echo "📖 Instructions:"
echo "   1. Keep this terminal window open"
echo "   2. On iPad: Start the UltraDeepThink app"
echo "   3. On iPad: Press 'Start Service'"
echo "   4. On iPad: Press 'Send ultradeepthink'"
