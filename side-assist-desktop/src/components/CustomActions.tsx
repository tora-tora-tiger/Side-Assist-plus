...
export interface CustomActionsRef {
  reload: () => Promise<void>;
}

export const CustomActions = forwardRef<CustomActionsRef, CustomActionsProps>(
  ({ onLog }, ref) => {
    const [customActions, setCustomActions] = useState<CustomAction[]>([]);
    const [isLoading, setIsLoading] = useState(false);
    const [editingAction, setEditingAction] = useState<CustomAction | null>(
      null
    );
