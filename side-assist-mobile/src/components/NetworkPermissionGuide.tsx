...
export const NetworkPermissionGuide: React.FC<NetworkPermissionGuideProps> = ({
  ...
  return (
    <View className="absolute inset-0 bg-black/80 justify-center items-center z-50 p-5">
      <View className="bg-gray-900 rounded-xl p-6 w-full max-w-sm border border-gray-700">
        ...
        <View className="flex-row justify-between space-x-3">
          <TouchableOpacity
            className="flex-1 bg-success py-3 px-4 rounded-lg items-center"
          ...
          <TouchableOpacity
            className="flex-1 bg-transparent py-3 px-4 rounded-lg border border-gray-600 items-center"
            onPress={onDismiss}
          >
